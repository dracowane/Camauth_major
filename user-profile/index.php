    ...
    <div class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Camauth Profile</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav ">
                    ...
                    <li><a href="http://127.0.0.1/Camauth/logout.php">LOGOUT</a></li>
                </ul>
            </div>
        ...
        <section style="padding-bottom: 50px; padding-top: 50px;">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder=<?php echo $_SESSION['uame'];?>>
